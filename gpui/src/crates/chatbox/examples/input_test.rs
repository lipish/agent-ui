        ...
        match cx.open_window(
            WindowOptions {
                titlebar: Some(TitlebarOptions {
                    title: Some("Text Input Test".into()),
            ...
            |_window, cx| {
                let input_test = cx.new(|cx| InputTest::new(cx));
                input_test.into()
            },
        ) {
            Ok(_) => println!("✅ Text Input Test launched!"),
